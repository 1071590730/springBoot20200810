...
/**
 * Created by ASUS on 2020/8/25 14:18
 */
//配置类
@Configuration
//主键
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean() {
        ...
        shiroFilter.setLoginUrl("/account/login");//登陆页
        shiroFilter.setSuccessUrl("/account/dashboard");//登陆成功
        shiroFilter.setUnauthorizedUrl("/error/403");//没有权限
