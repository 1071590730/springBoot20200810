package com.wjb.springcloud.springCloudClientAccount.modules.common.vo;
...
public class SearchVo {
    ...
    public final static int DEFAULT_CURRENT_PAGE = 1;//当前页
    public final static int DEFAULT_PAGE_SIZE = 5;//页大小（行数）
